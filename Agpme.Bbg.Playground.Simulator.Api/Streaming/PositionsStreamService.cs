...
public sealed class PositionsStreamService : IPositionsStreamService
{
    ...
    private static readonly TimeSpan HeartbeatDelayNoUpdates = TimeSpan.FromSeconds(3);
        ...
        CancellationToken ct)
    {
        ...
        {
            Log.Information(
                "Stream start: entityType={EntityType}, entityName={EntityName}, asOfDate={AsOf}, chunk={Chunk}",
